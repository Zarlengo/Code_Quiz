var HTMLquestions= [
	...
	{
		title:"Question 23",
		question:"The year in which HTML was first proposed ___.",
		answers:{
			a:"1990",
			b:"1980",
			c:"2000",
	...
	{
		title:"Question 24",
		question:"Fundamental HTML Block is known as ___.",
		answers:{
			a:"HTML Body",
			b:"HTML Tag",
			c:"HTML Attribute",
	...
	{
		title:"Question 30",
		question:"HTML web pages can be read and rendered by ___?",
		answers:{
			a:"Compiler",
			b:"Server",
			c:"Web Browser",
	...
	{
		title:"Question 34",
		question:"Tags and texts that are not directly displayed on the page are written in ___ section.",
		answers:{
			a:"<head>",
			b:"<title>",
			c:"<body>",
